...
-   `txData` **[string][1]** the transaction input data
-   `encoding` **[string][1]** `base64` or `hex`

Returns **[string][1]** the transaction type.
...
Returns **[string][1]** The explorer url for thorchain based on the given network.
